...
export default function Era({ era, onChoiceSelected, scenarioId = null }) {
    ...
    return (
        <div className="flex flex-col flex-grow">
            ...
            <h2 className="text-4xl font-bold mt-16 sinister-text sm:text-2xl"
                style={sinisterStyle}>
                What will you do?
            </h2>

            <div className="choices mt-4 flex flex-row justify-items-stretch items-stretch gap-16 md:pl-32 md:pr-32">
